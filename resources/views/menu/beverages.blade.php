...
<section class="relative w-3/4 mx-auto h-screen">
    ...
    <div class="text-center space-x-4 mt-8">
        ...
        <a href="{{ route('beverages') }}" class="text-secondary border-b border-secondary font-semibold">beverages</a>
        <a href="{{ route('dessert') }}" class="hover:border-b hover:border-secondary">dessert</a>
    </div>
